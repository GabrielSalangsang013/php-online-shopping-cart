                ...
                <div class="products-container">
                    ...
                    <?php
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo        "<input type='hidden' name='image' class='text-product-image' value='". $row["PRODUCT_IMAGE"] . "'>";
                            ...
                            if(mysqli_num_rows($result) == 0) {
                                echo "<div action='insert.php' class='product-container' method='GET' target='_blank' onsubmit='pass()'>";
                                echo    "<div class='product-image-container'>";
                                echo        "<img src='img/others/search.png' style='margin-top: 50px;' class='product-image givenProductImage' alt=''>";
                                echo        "<input type='hidden' name='image' class='text-product-image'>";
                                echo        "<input type='hidden' name='productid' class='text-product-id' value=''>";
                                echo    "</div>";
                                echo    "<div class='product-container-alert-text'>";
                                echo        "<h2>Sorry we didn't find any data</h2>";
                                echo    "</div>";
                                echo"</div>";
                            }
